        ...
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="hidden md:flex items-center space-x-6 text-sm font-medium text-gray-500 dark:text-slate-400">
            ...
            <div className="flex items-center gap-3 pl-4 border-l border-gray-200 dark:border-slate-700">
              <div className="h-8 w-8 rounded-full bg-indigo-600 border border-indigo-200 dark:border-slate-600 overflow-hidden ring-2 ring-transparent hover:ring-indigo-400 transition-all flex items-center justify-center">
                {userProfile?.avatar
